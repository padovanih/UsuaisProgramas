...
for linha in vet:
	...
	if(words[3] == 'padovani:'):
		...
		# Caso a mensagem era só um emoji por exemplo, vai ficar vazio
...
# dicPessoas = sorted(dicPessoas.items(), key=lambda x: x[1])
...
retirar = ["ta","na","uns","umas","um","uma","pela","as","os","mas","que","e","o","a","ante","apos","ate","com","conforme","contra","consoante","de","desde","durante","em","excepto","entre","mediante","para","perante","por","salvo","sem","segundo","sob","sobre", "tras"]
